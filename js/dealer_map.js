        ...
        $.ajax({
            ...
            $(data).each(function(i, item){
                ...
                closeIconElement.onclick = () => {
                    isCloseClick = true;
                    window.setTimeout(function() { isCloseClick = false; }, 600);
                        ...
                        onClick() {
                            if (!isCloseClick) {
                                ...
                                $.ajax({
                                    ...
                                    curElement.find('.new-map-point-popup-content .dealers-contacts-item-copy').each(function() {
                                        var curItem = $(this);
                                        ...
                                        clipboardContacts.on('success', function(e) {
                                            ...
                                            window.setTimeout(function() { isCloseClick = false; }, 500);
                                        });
                                    });
                                });
                            }
